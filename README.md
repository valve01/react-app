...
<!-- 
 ...
 -->
<!-- ========================================================================================================================================== -->
<!-- Переносим логику axios внутрь слайса -->
<!-- Нельзя в редаксе заниматься чем-то другим, кроме хранения и изменения модели данных. (Нельзя добавлять сайд эффекты, иначе а-та-та), все сайд эффекты делай внутри компонента, а не в редаксе -->
<!-- Нельзя просто скопипастить axios запрос в слайс -->
<!-- Нужно создать асинхронный экшен с помощью метода redux - createAsyncThunk-->
<!-- export const fetchPizzas = createAsyncThunk() -->
<!-- В pizzaSlice автоматически должен добавиться к импорту новый метод createAsyncThunk -->
<!-- import { createAsyncThunk, createSlice } from '@reduxjs/toolkit'; -->
<!-- Этот метод и создает асинхронный экшн -->
<!-- При помощи такого экшена мы будем производить сразу несколько последовательных действий, завязанных на редаксе -->
<!-- Например запрос, данных, их сохранение и показ статуса загрузки, и не писать при этом 3 разных диспатча для этого -->
