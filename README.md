...
<!-- immer - это библиотека, благодаря которой наши непримитивы ([] и {}) нельзя будет мутировать напрямую -->
...
<!-- immer работает так: мы создаем объект, передаем его в immer, immer создает копию изначального объекта, которую мы и изменяем, и возвращает immer нам отредактированную копию изначального объекта, который теперь  -->
