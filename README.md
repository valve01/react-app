...
<!-- Сейчас принято использовать css модули, БЭМ при этом не нужен, достигается инкапсуляция стилей, нет конфликтов классов. Перед расширение указываем прификс module.[ext] -->
