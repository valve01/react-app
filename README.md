...
<!-- Есть полезный нам хук useWhyDidYouUpdate. Который может показать собственно почему обновляется тот или иной компонент -->
...
<!-- как и у useEffect тут есть зависимости - []. -->
